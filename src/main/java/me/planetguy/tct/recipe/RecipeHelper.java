package me.planetguy.tct.recipe;
...
public class RecipeHelper {
	...
	public static int canCraftWithComponents(WrappedRecipe recipe,
			InventoryPlayer inventory, boolean takeItems, int maxTimes,
			int maxRecursion) {
		return canCraftWithComponents(recipe, inventory, takeItems, maxTimes, maxRecursion, new ArrayDeque());
	}
