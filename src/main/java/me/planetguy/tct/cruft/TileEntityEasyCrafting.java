package me.planetguy.tct.cruft;

import me.planetguy.tct.inventory.gui.ContainerEasyCrafting;
import me.planetguy.tct.inventory.gui.GuiTCT;
...
public class TileEntityEasyCrafting extends TileEntity implements IInventory {
    ...
    public Object getClientGuiElement(EntityPlayer player, TileEntity tileEntity) {
        if (tileEntity instanceof TileEntityEasyCrafting) {
            return new GuiTCT(player.inventory, ((TileEntityEasyCrafting) tileEntity));
        }
        return null;
    }
}